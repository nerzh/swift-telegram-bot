 ...
 **/
public final class TGTransactionPartnerAffiliateProgram: Codable, Sendable {
    ...
    public let type: TGTransactionPartnerAffiliateProgramType

    /// Optional. Information about the bot that sponsored the affiliate program
    public let sponsorUser: TGUser?
