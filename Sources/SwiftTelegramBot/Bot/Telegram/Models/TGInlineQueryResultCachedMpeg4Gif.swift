...
public final class TGInlineQueryResultCachedMpeg4Gif: Codable, Sendable {
    ...
    public init (type: TGInlineQueryResultCachedMpeg4GifType, id: String, mpeg4FileId: String, title: String? = nil, caption: String? = nil, parseMode: TGParseMode? = nil, captionEntities: [TGMessageEntity]? = nil, showCaptionAboveMedia: Bool? = nil, replyMarkup: TGInlineKeyboardMarkup? = nil, inputMessageContent: TGInputMessageContent? = nil) {
        self.type = type
        self.id = id
