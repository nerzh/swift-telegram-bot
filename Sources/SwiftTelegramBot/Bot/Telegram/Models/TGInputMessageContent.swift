...
public enum TGInputMessageContent: Codable, Sendable {
    ...
    case inputRichMessageContent(TGInputRichMessageContent)
    ...
    public init(from decoder: Decoder) throws {
        ...
        } else if let value = try? container.decode(TGInputRichMessageContent.self) {
            self = .inputRichMessageContent(value)
