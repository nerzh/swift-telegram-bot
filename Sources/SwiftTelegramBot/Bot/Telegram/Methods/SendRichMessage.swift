...
/// Parameters container struct for `sendRichMessage` method
public struct TGSendRichMessageParams: Encodable, Sendable {
    ...
    /// Custom keys for coding/decoding `SendRichMessageParams` struct
    ...
    public init(businessConnectionId: String? = nil, chatId: TGChatId, messageThreadId: Int? = nil, directMessagesTopicId: Int? = nil, ephemeralMessageParameters: TGEphemeralMessageParameters? = nil, richMessage: TGInputRichMessage, disableNotification: Bool? = nil, protectContent: Bool? = nil, allowPaidBroadcast: Bool? = nil, messageEffectId: String? = nil, suggestedPostParameters: TGSuggestedPostParameters? = nil, replyParameters: TGReplyParameters? = nil, replyMarkup: TGReplyMarkup? = nil) {
...
/**
 ...
 - Parameters:
     - params: Parameters container, see `SendRichMessageParams` struct
 - Throws: Throws on errors
 - Returns: `TGMessage`
 */

    @discardableResult
    func sendRichMessage(params: TGSendRichMessageParams) async throws -> TGMessage {
        guard let methodURL: URL = .init(string: getMethodURL("sendRichMessage")) else {
            throw BotError("Bad URL: \(getMethodURL("sendRichMessage"))")
        }
